...
namespace House
{
    public partial class Form1 : Form
    {
        ...
        private void CreateObjects()
        {
            ...
            diningRoom = new RoomWithHidingPlace("Dining Room", "a chystal chandelier", "in the tall armoire");
            kitchen = new RoomWithDoor("Kitchen", "stainless steel appliences", "in the cabinet", "a screen door");
